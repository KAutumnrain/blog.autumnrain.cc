...
BLOG_AUTHOR = "kat"  # (translatable)
BLOG_TITLE = "Converging Infinity"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.autumnrain.cc/"
...
NAVIGATION_ALT_LINKS = {
    DEFAULT_LANG: (
        ("https://autumnrain.cc", "_RETURN.MAIN"),
        )
}
...
# "/images/foo.jpg"
DEFAULT_PREVIEW_IMAGE = "https://autumnrain.cc/images/convinfweb.png"
...
# is in the manual.
COMMENT_SYSTEM_ID = "kautumnrain/blog.autumnrain.cc"
...
GLOBAL_CONTEXT = {'utterances_config': {"issue-term": "pathname", "label": "[comment]", "theme": "github-dark", "crossorigin":"anonymous"}, 'HACK_VARIANT': 'dark'}
